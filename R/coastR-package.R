#' coastR: Coastal oceanography in R
#'
#' This package contains several functions designed to address common problems
#' faced in coastal oceanography.
#'
#' @details The main function in this package currently is \code{\link{seq_sites}}.
...
#' @section coastR functions:
#' seq_sites
#' deg_rad
#'
#' @references Schlegel, R.W., Smit, A.J., 2016. Climate change in coastal waters:
#' time series properties affecting trend estimation. J. Clim. 29 (24), 9113–9124.
